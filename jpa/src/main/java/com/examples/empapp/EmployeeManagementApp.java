		...
		while (true) {
			...
			try {
				...
				case 3:
					System.out.print("Please enter employee id: ");
					empId = in.nextInt();
					Employee empForUpdate=new Employee();
				
					captureEmpDetail(empForUpdate);
					empService.update(empId,empForUpdate);
...
//							Thread.sleep(5000);
	...
	private static void printStatistics() {
		...
		System.out.println("Employee count by Department ordered: " + empService.getEmployeeCountByDepartmentOrdered());
	}
